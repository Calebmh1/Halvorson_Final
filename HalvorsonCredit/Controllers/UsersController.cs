...
namespace HalvorsonCredit.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(HalvorsoncreditContext context, JwtAuthenticationManager authManager)
        {
            _context = context;
        ...
        public async Task<ActionResult<User>> PostUser(User user)
        {
          if (_context.Users == null)
          {
              return Problem("Entity set 'HalvorsoncreditContext.Users'  is null.");
          }
